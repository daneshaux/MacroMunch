// src/components/OnboardingGoalCard/OnboardingGoalCard.jsx
import styles from "./OnboardingGoalCard.module.css";

function OnboardingGoalCard({
  label,
  description,
  icon,
  iconSrc,
...
export default OnboardingGoalCard;
